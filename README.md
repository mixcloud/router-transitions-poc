...
- That branch now carries TanStack Router `main` at
  ...
  is `5ed6e40b`, four commits on from `81418ff`, the merge of that commit,
  ...
  move together. The published measurements are from `cc08459`, forty-five
  ...
  kept out of the structural-sharing cache — and none of it changes the
