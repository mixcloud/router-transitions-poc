...
// The tally assertion below throws on purpose when the page exposes no
// witness, and the launch above sits outside it. Closing in a `finally` keeps
// the teardown this script's own rather than the runtime's, the same way the
// benchmark does.
try {
